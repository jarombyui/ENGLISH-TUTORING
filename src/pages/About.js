      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-2xl text-white max-w-3xl mx-auto font-['Poppins']">
            INGENIUM ACADEMY: Expertos en soluciones de ventas, desarrollo web y software a medida para empresas y emprendedores visionarios.
          </p>
        </div>
        ...
        <div className="grid gap-10 md:grid-cols-2 mb-16">
          <div className="bg-gray-900 border border-yellow-500 rounded-3xl shadow-2xl p-10 flex flex-col items-center hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-white font-['Poppins'] text-lg">Impulsar la transformación digital de nuestros clientes, creando software innovador, seguro y de alta calidad que potencie sus negocios.</p>
          </div>
          ...
          <div className="bg-gray-900 border border-yellow-500 rounded-3xl shadow-2xl p-10 flex flex-col items-center hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-white font-['Poppins'] text-lg">Ser referentes en el sector tecnológico, brindando soluciones que marquen la diferencia y generen valor en cada proyecto.</p>
          </div>
        </div>
        ...
        <div className="bg-gray-900 border border-yellow-500 rounded-3xl shadow-2xl p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center group hover:scale-105 transition-transform duration-300">
              ...
              <h4 className="font-semibold text-yellow-500 text-lg font-['Montserrat'] mb-1">Excelencia</h4>
              <p className="text-white font-['Poppins']">Buscamos la máxima calidad en cada línea de código y en la atención a nuestros clientes.</p>
            </div>
            <div className="flex flex-col items-center text-center group hover:scale-105 transition-transform duration-300">
              <div className="bg-yellow-500/10 text-yellow-500 rounded-full p-4 mb-3 shadow-lg group-hover:bg-yellow-500 group-hover:text-black transition-colors duration-300">
              ...
              <h4 className="font-semibold text-yellow-500 text-lg font-['Montserrat'] mb-1">Integridad</h4>
              <p className="text-white font-['Poppins']">Actuamos con honestidad, transparencia y compromiso en cada proyecto.</p>
            </div>
            <div className="flex flex-col items-center text-center group hover:scale-105 transition-transform duration-300">
              <div className="bg-yellow-500/10 text-yellow-500 rounded-full p-4 mb-3 shadow-lg group-hover:bg-yellow-500 group-hover:text-black transition-colors duration-300">
              ...
              <h4 className="font-semibold text-yellow-500 text-lg font-['Montserrat'] mb-1">Innovación</h4>
              <p className="text-white font-['Poppins']">Adoptamos nuevas tecnologías y metodologías para ofrecer soluciones modernas y eficientes.</p>
            </div>
          </div>
        </div>
      </div>
