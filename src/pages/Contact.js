...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contáctanos | INGENIUM ACADEMY</title>
        <meta name="description" content="¿Tienes dudas o quieres inscribirte? Contáctanos para más información sobre nuestros cursos de inglés, cultura americana y certificación internacional." />
        <meta property="og:title" content="Contáctanos | INGENIUM ACADEMY" />
        <meta property="og:description" content="Contáctanos para más información sobre nuestros cursos de inglés, cultura americana y certificación internacional." />
        <meta property="og:image" content="https://ingeniumacademy.netlify.app/images/ingenium-academy-logo.png" />
        <meta property="og:url" content="https://ingeniumacademy.netlify.app/contacto" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-2xl text-white max-w-2xl mx-auto font-['Poppins']">
              ¿Tienes dudas, consultas o quieres inscribirte? ¡Estamos para ayudarte!
            </p>
          </div>

          <div className="mt-12 grid gap-8 md:grid-cols-2">
            {/* Contact Information */}
            <div className="bg-gray-900 rounded-lg shadow-lg p-6 border-yellow-500">
              ...
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-2">Horario de Atención</h4>
            ...
            <div className="bg-gray-900 rounded-lg shadow-lg p-6 border-yellow-500">
              <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="user_phone" className="block text-sm font-medium text-white">
                    Teléfono
                  </label>
                  <input
                    type="tel"
