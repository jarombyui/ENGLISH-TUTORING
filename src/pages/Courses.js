...
const Courses = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Cursos de Inglés y Cultura Americana | INGENIUM ACADEMY</title>
        <meta name="description" content="Descubre nuestros cursos de inglés intensivo, cultura americana, conversatorios con nativos, asesoría universitaria y certificación internacional." />
        <meta property="og:title" content="Cursos de Inglés y Cultura Americana | INGENIUM ACADEMY" />
        <meta property="og:description" content="Cursos de inglés, cultura americana, asesoría universitaria y certificación internacional. ¡Inscríbete ahora!" />
        <meta property="og:image" content="https://ingeniumacademy.netlify.app/images/ingenium-academy-logo.png" />
        <meta property="og:url" content="https://ingeniumacademy.netlify.app/cursos" />
      </Helmet>
